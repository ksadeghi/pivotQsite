import{b as St}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-ROG2Z67P.js";import{a as co}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-MRDOZWGK.js";import{A as eo,B as to,C as no,D as ro,E as oo,a as Ie,b as Qe,c as Dr,d as Br,e as wt,f as Kr,g as Wr,h as Hr,i as Gr,j as qr,k as Vr,l as Fe,m as ze,n as Ke,o as xe,p as Zr,q as We,s as jr,t as ji,u as ee,v as Xr,w as Jr,y as cn,z as Qr}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-N4SLXUGN.js";import{a as Be,b as an,c as Lr,d as yt,e as Ur}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-KMCRHZNH.js";import"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-E5P5FVIW.js";import{a as lo}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-W7UPAHR4.js";import{a as Me,b as Tr,c as _r,d as De,g as Ue,h as ce,v as io,x as so,z as ao}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-IH4X2UOT.js";import{a as Fr,c as $r,e as bt,f as zr,j as Le,k as vt}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-TBSIZWO5.js";import{a as Or}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-KRI7MVRE.js";import{a as nr,b as Yt,d as ye,e as Zt,f as oe,h as sn,i as kr,j as Pr,k as Nr,n as Mr,o as Rr,p as Yr}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-OLS7ZE5V.js";import{$ as re,A as Vn,Ab as nn,B as Gt,C as Re,D as qt,E as mt,F as Yn,Fa as Xt,G as Vt,H as Zn,Ha as Jt,I as jn,Ib as te,J as Xn,Ja as me,K as Jn,Ka as X,Kb as Ir,L as Ze,M as Qn,Mb as ht,N as er,Nb as rn,O as tr,Ob as xr,R as pt,Ra as lr,S as T,Sa as Q,U as Ce,Ub as Ar,V as je,Vb as on,X as rr,Xa as Qt,Y as U,Ya as en,Z as or,Za as Oe,_a as gt,a as Bn,ab as ae,b as Vi,c as L,cb as ur,d as $,db as mr,e as H,ea as Yi,eb as pr,ec as $e,f as Ln,fa as Zi,fb as ft,fc as j,g as Un,gb as Xe,h as Se,ha as jt,hb as gr,i as R,ib as Je,j as se,k as Fn,kb as fr,l as v,m as $n,ma as ir,n as Z,o as Ye,ob as tn,p as k,pb as hr,q as zn,qb as yr,r as Kn,rb as br,s as Wn,sa as sr,t as Hn,ta as ar,tb as vr,u as Gn,ub as wr,v as qn,vb as Sr,w as B,wb as pe,x as Wt,xa as cr,xb as Cr,y as he,ya as dr,yb as Ee,z as Ht,zb as Er}from"./6dde4961d28ef86467df9880c03b15ccb70e5f49-chunk-JTCGJ5GI.js";var Do=Bn((Hd,Oo)=>{var Os=Zi(),Ds=Yi(),Bs="Expected a function";function Ls(t,e,n){var r=!0,o=!0;if(typeof t!="function")throw new TypeError(Bs);return Ds(n)&&(r="leading"in n?!!n.leading:r,o="trailing"in n?!!n.trailing:o),Os(t,e,{leading:r,maxWait:e,trailing:o})}Oo.exports=Ls});var Ri=Bn((ot,Dt)=>{(function(t,e){"use strict";var n="0.7.33",r="",o="?",i="function",s="undefined",m="object",d="string",p="major",a="model",l="name",c="type",u="vendor",g="version",b="architecture",y="console",f="mobile",h="tablet",w="smarttv",C="wearable",O="embedded",_=350,S="Amazon",D="Apple",P="ASUS",N="BlackBerry",z="Browser",V="Chrome",Wi="Edge",it="Firefox",st="Google",Tn="Huawei",Bt="LG",Lt="Microsoft",_n="Motorola",at="Opera",Ut="Samsung",kn="Sharp",ct="Sony",Ft="Xiaomi",$t="Zebra",Pn="Facebook",Hi=function(I,M){var x={};for(var K in I)M[K]&&M[K].length%2===0?x[K]=M[K].concat(I[K]):x[K]=I[K];return x},dt=function(I){for(var M={},x=0;x<I.length;x++)M[I[x].toUpperCase()]=I[x];return M},Nn=function(I,M){return typeof I===d?Ge(M).indexOf(Ge(I))!==-1:!1},Ge=function(I){return I.toLowerCase()},Gi=function(I){return typeof I===d?I.replace(/[^\d\.]/g,r).split(".")[0]:e},zt=function(I,M){if(typeof I===d)return I=I.replace(/^\s\s*/,r),typeof M===s?I:I.substring(0,_)},qe=function(I,M){for(var x=0,K,A,ut,F,Ve,ie;x<M.length&&!Ve;){var On=M[x],Dn=M[x+1];for(K=A=0;K<On.length&&!Ve;)if(Ve=On[K++].exec(I),Ve)for(ut=0;ut<Dn.length;ut++)ie=Ve[++A],F=Dn[ut],typeof F===m&&F.length>0?F.length===2?typeof F[1]==i?this[F[0]]=F[1].call(this,ie):this[F[0]]=F[1]:F.length===3?typeof F[1]===i&&!(F[1].exec&&F[1].test)?this[F[0]]=ie?F[1].call(this,ie,F[2]):e:this[F[0]]=ie?ie.replace(F[1],F[2]):e:F.length===4&&(this[F[0]]=ie?F[3].call(this,ie.replace(F[1],F[2])):e):this[F]=ie||e;x+=2}},Kt=function(I,M){for(var x in M)if(typeof M[x]===m&&M[x].length>0){for(var K=0;K<M[x].length;K++)if(Nn(M[x][K],I))return x===o?e:x}else if(Nn(M[x],I))return x===o?e:x;return I},qi={"1.0":"/8",1.2:"/1",1.3:"/3","2.0":"/412","2.0.2":"/416","2.0.3":"/417","2.0.4":"/419","?":"/"},Mn={ME:"4.90","NT 3.11":"NT3.51","NT 4.0":"NT4.0",2e3:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2",8.1:"NT 6.3",10:["NT 6.4","NT 10.0"],RT:"ARM"},Rn={browser:[[/\b(?:crmo|crios)\/([\w\.]+)/i],[g,[l,"Chrome"]],[/edg(?:e|ios|a)?\/([\w\.]+)/i],[g,[l,"Edge"]],[/(opera mini)\/([-\w\.]+)/i,/(opera [mobiletab]{3,6})\b.+version\/([-\w\.]+)/i,/(opera)(?:.+version\/|[\/ ]+)([\w\.]+)/i],[l,g],[/opios[\/ ]+([\w\.]+)/i],[g,[l,at+" Mini"]],[/\bopr\/([\w\.]+)/i],[g,[l,at]],[/(kindle)\/([\w\.]+)/i,/(lunascape|maxthon|netfront|jasmine|blazer)[\/ ]?([\w\.]*)/i,/(avant |iemobile|slim)(?:browser)?[\/ ]?([\w\.]*)/i,/(ba?idubrowser)[\/ ]?([\w\.]+)/i,/(?:ms|\()(ie) ([\w\.]+)/i,/(flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon|rekonq|puffin|brave|whale|qqbrowserlite|qq|duckduckgo)\/([-\w\.]+)/i,/(weibo)__([\d\.]+)/i],[l,g],[/(?:\buc? ?browser|(?:juc.+)ucweb)[\/ ]?([\w\.]+)/i],[g,[l,"UC"+z]],[/microm.+\bqbcore\/([\w\.]+)/i,/\bqbcore\/([\w\.]+).+microm/i],[g,[l,"WeChat(Win) Desktop"]],[/micromessenger\/([\w\.]+)/i],[g,[l,"WeChat"]],[/konqueror\/([\w\.]+)/i],[g,[l,"Konqueror"]],[/trident.+rv[: ]([\w\.]{1,9})\b.+like gecko/i],[g,[l,"IE"]],[/yabrowser\/([\w\.]+)/i],[g,[l,"Yandex"]],[/(avast|avg)\/([\w\.]+)/i],[[l,/(.+)/,"$1 Secure "+z],g],[/\bfocus\/([\w\.]+)/i],[g,[l,it+" Focus"]],[/\bopt\/([\w\.]+)/i],[g,[l,at+" Touch"]],[/coc_coc\w+\/([\w\.]+)/i],[g,[l,"Coc Coc"]],[/dolfin\/([\w\.]+)/i],[g,[l,"Dolphin"]],[/coast\/([\w\.]+)/i],[g,[l,at+" Coast"]],[/miuibrowser\/([\w\.]+)/i],[g,[l,"MIUI "+z]],[/fxios\/([-\w\.]+)/i],[g,[l,it]],[/\bqihu|(qi?ho?o?|360)browser/i],[[l,"360 "+z]],[/(oculus|samsung|sailfish|huawei)browser\/([\w\.]+)/i],[[l,/(.+)/,"$1 "+z],g],[/(comodo_dragon)\/([\w\.]+)/i],[[l,/_/g," "],g],[/(electron)\/([\w\.]+) safari/i,/(tesla)(?: qtcarbrowser|\/(20\d\d\.[-\w\.]+))/i,/m?(qqbrowser|baiduboxapp|2345Explorer)[\/ ]?([\w\.]+)/i],[l,g],[/(metasr)[\/ ]?([\w\.]+)/i,/(lbbrowser)/i,/\[(linkedin)app\]/i],[l],[/((?:fban\/fbios|fb_iab\/fb4a)(?!.+fbav)|;fbav\/([\w\.]+);)/i],[[l,Pn],g],[/safari (line)\/([\w\.]+)/i,/\b(line)\/([\w\.]+)\/iab/i,/(chromium|instagram)[\/ ]([-\w\.]+)/i],[l,g],[/\bgsa\/([\w\.]+) .*safari\//i],[g,[l,"GSA"]],[/headlesschrome(?:\/([\w\.]+)| )/i],[g,[l,V+" Headless"]],[/ wv\).+(chrome)\/([\w\.]+)/i],[[l,V+" WebView"],g],[/droid.+ version\/([\w\.]+)\b.+(?:mobile safari|safari)/i],[g,[l,"Android "+z]],[/(chrome|omniweb|arora|[tizenoka]{5} ?browser)\/v?([\w\.]+)/i],[l,g],[/version\/([\w\.\,]+) .*mobile\/\w+ (safari)/i],[g,[l,"Mobile Safari"]],[/version\/([\w(\.|\,)]+) .*(mobile ?safari|safari)/i],[g,l],[/webkit.+?(mobile ?safari|safari)(\/[\w\.]+)/i],[l,[g,Kt,qi]],[/(webkit|khtml)\/([\w\.]+)/i],[l,g],[/(navigator|netscape\d?)\/([-\w\.]+)/i],[[l,"Netscape"],g],[/mobile vr; rv:([\w\.]+)\).+firefox/i],[g,[l,it+" Reality"]],[/ekiohf.+(flow)\/([\w\.]+)/i,/(swiftfox)/i,/(icedragon|iceweasel|camino|chimera|fennec|maemo browser|minimo|conkeror|klar)[\/ ]?([\w\.\+]+)/i,/(seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([-\w\.]+)$/i,/(firefox)\/([\w\.]+)/i,/(mozilla)\/([\w\.]+) .+rv\:.+gecko\/\d+/i,/(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir|obigo|mosaic|(?:go|ice|up)[\. ]?browser)[-\/ ]?v?([\w\.]+)/i,/(links) \(([\w\.]+)/i],[l,g],[/(cobalt)\/([\w\.]+)/i],[l,[g,/master.|lts./,""]]],cpu:[[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i],[[b,"amd64"]],[/(ia32(?=;))/i],[[b,Ge]],[/((?:i[346]|x)86)[;\)]/i],[[b,"ia32"]],[/\b(aarch64|arm(v?8e?l?|_?64))\b/i],[[b,"arm64"]],[/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i],[[b,"armhf"]],[/windows (ce|mobile); ppc;/i],[[b,"arm"]],[/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i],[[b,/ower/,r,Ge]],[/(sun4\w)[;\)]/i],[[b,"sparc"]],[/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i],[[b,Ge]]],device:[[/\b(sch-i[89]0\d|shw-m380s|sm-[ptx]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i],[a,[u,Ut],[c,h]],[/\b((?:s[cgp]h|gt|sm)-\w+|galaxy nexus)/i,/samsung[- ]([-\w]+)/i,/sec-(sgh\w+)/i],[a,[u,Ut],[c,f]],[/((ipod|iphone)\d+,\d+)/i],[a,[u,D],[c,f]],[/(ipad\d+,\d+)/i],[a,[u,D],[c,h]],[/\((ip(?:hone|od)[\w ]*);/i],[a,[u,D],[c,f]],[/\((ipad);[-\w\),; ]+apple/i,/applecoremedia\/[\w\.]+ \((ipad)/i,/\b(ipad)\d\d?,\d\d?[;\]].+ios/i],[a,[u,D],[c,h]],[/(macintosh);/i],[a,[u,D]],[/\b((?:ag[rs][23]?|bah2?|sht?|btv)-a?[lw]\d{2})\b(?!.+d\/s)/i],[a,[u,Tn],[c,h]],[/(?:huawei|honor)([-\w ]+)[;\)]/i,/\b(nexus 6p|\w{2,4}e?-[atu]?[ln][\dx][012359c][adn]?)\b(?!.+d\/s)/i],[a,[u,Tn],[c,f]],[/\b(poco[\w ]+)(?: bui|\))/i,/\b; (\w+) build\/hm\1/i,/\b(hm[-_ ]?note?[_ ]?(?:\d\w)?) bui/i,/\b(redmi[\-_ ]?(?:note|k)?[\w_ ]+)(?: bui|\))/i,/\b(mi[-_ ]?(?:a\d|one|one[_ ]plus|note lte|max|cc)?[_ ]?(?:\d?\w?)[_ ]?(?:plus|se|lite)?)(?: bui|\))/i],[[a,/_/g," "],[u,Ft],[c,f]],[/\b(mi[-_ ]?(?:pad)(?:[\w_ ]+))(?: bui|\))/i],[[a,/_/g," "],[u,Ft],[c,h]],[/; (\w+) bui.+ oppo/i,/\b(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007|a101op)\b/i],[a,[u,"OPPO"],[c,f]],[/vivo (\w+)(?: bui|\))/i,/\b(v[12]\d{3}\w?[at])(?: bui|;)/i],[a,[u,"Vivo"],[c,f]],[/\b(rmx[12]\d{3})(?: bui|;|\))/i],[a,[u,"Realme"],[c,f]],[/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i,/\bmot(?:orola)?[- ](\w*)/i,/((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i],[a,[u,_n],[c,f]],[/\b(mz60\d|xoom[2 ]{0,2}) build\//i],[a,[u,_n],[c,h]],[/((?=lg)?[vl]k\-?\d{3}) bui| 3\.[-\w; ]{10}lg?-([06cv9]{3,4})/i],[a,[u,Bt],[c,h]],[/(lm(?:-?f100[nv]?|-[\w\.]+)(?= bui|\))|nexus [45])/i,/\blg[-e;\/ ]+((?!browser|netcast|android tv)\w+)/i,/\blg-?([\d\w]+) bui/i],[a,[u,Bt],[c,f]],[/(ideatab[-\w ]+)/i,/lenovo ?(s[56]000[-\w]+|tab(?:[\w ]+)|yt[-\d\w]{6}|tb[-\d\w]{6})/i],[a,[u,"Lenovo"],[c,h]],[/(?:maemo|nokia).*(n900|lumia \d+)/i,/nokia[-_ ]?([-\w\.]*)/i],[[a,/_/g," "],[u,"Nokia"],[c,f]],[/(pixel c)\b/i],[a,[u,st],[c,h]],[/droid.+; (pixel[\daxl ]{0,6})(?: bui|\))/i],[a,[u,st],[c,f]],[/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[a,[u,ct],[c,f]],[/sony tablet [ps]/i,/\b(?:sony)?sgp\w+(?: bui|\))/i],[[a,"Xperia Tablet"],[u,ct],[c,h]],[/ (kb2005|in20[12]5|be20[12][59])\b/i,/(?:one)?(?:plus)? (a\d0\d\d)(?: b|\))/i],[a,[u,"OnePlus"],[c,f]],[/(alexa)webm/i,/(kf[a-z]{2}wi)( bui|\))/i,/(kf[a-z]+)( bui|\)).+silk\//i],[a,[u,S],[c,h]],[/((?:sd|kf)[0349hijorstuw]+)( bui|\)).+silk\//i],[[a,/(.+)/g,"Fire Phone $1"],[u,S],[c,f]],[/(playbook);[-\w\),; ]+(rim)/i],[a,u,[c,h]],[/\b((?:bb[a-f]|st[hv])100-\d)/i,/\(bb10; (\w+)/i],[a,[u,N],[c,f]],[/(?:\b|asus_)(transfo[prime ]{4,10} \w+|eeepc|slider \w+|nexus 7|padfone|p00[cj])/i],[a,[u,P],[c,h]],[/ (z[bes]6[027][012][km][ls]|zenfone \d\w?)\b/i],[a,[u,P],[c,f]],[/(nexus 9)/i],[a,[u,"HTC"],[c,h]],[/(htc)[-;_ ]{1,2}([\w ]+(?=\)| bui)|\w+)/i,/(zte)[- ]([\w ]+?)(?: bui|\/|\))/i,/(alcatel|geeksphone|nexian|panasonic|sony(?!-bra))[-_ ]?([-\w]*)/i],[u,[a,/_/g," "],[c,f]],[/droid.+; ([ab][1-7]-?[0178a]\d\d?)/i],[a,[u,"Acer"],[c,h]],[/droid.+; (m[1-5] note) bui/i,/\bmz-([-\w]{2,})/i],[a,[u,"Meizu"],[c,f]],[/\b(sh-?[altvz]?\d\d[a-ekm]?)/i],[a,[u,kn],[c,f]],[/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[-_ ]?([-\w]*)/i,/(hp) ([\w ]+\w)/i,/(asus)-?(\w+)/i,/(microsoft); (lumia[\w ]+)/i,/(lenovo)[-_ ]?([-\w]+)/i,/(jolla)/i,/(oppo) ?([\w ]+) bui/i],[u,a,[c,f]],[/(archos) (gamepad2?)/i,/(hp).+(touchpad(?!.+tablet)|tablet)/i,/(kindle)\/([\w\.]+)/i,/(nook)[\w ]+build\/(\w+)/i,/(dell) (strea[kpr\d ]*[\dko])/i,/(le[- ]+pan)[- ]+(\w{1,9}) bui/i,/(trinity)[- ]*(t\d{3}) bui/i,/(gigaset)[- ]+(q\w{1,9}) bui/i,/(vodafone) ([\w ]+)(?:\)| bui)/i],[u,a,[c,h]],[/(surface duo)/i],[a,[u,Lt],[c,h]],[/droid [\d\.]+; (fp\du?)(?: b|\))/i],[a,[u,"Fairphone"],[c,f]],[/(u304aa)/i],[a,[u,"AT&T"],[c,f]],[/\bsie-(\w*)/i],[a,[u,"Siemens"],[c,f]],[/\b(rct\w+) b/i],[a,[u,"RCA"],[c,h]],[/\b(venue[\d ]{2,7}) b/i],[a,[u,"Dell"],[c,h]],[/\b(q(?:mv|ta)\w+) b/i],[a,[u,"Verizon"],[c,h]],[/\b(?:barnes[& ]+noble |bn[rt])([\w\+ ]*) b/i],[a,[u,"Barnes & Noble"],[c,h]],[/\b(tm\d{3}\w+) b/i],[a,[u,"NuVision"],[c,h]],[/\b(k88) b/i],[a,[u,"ZTE"],[c,h]],[/\b(nx\d{3}j) b/i],[a,[u,"ZTE"],[c,f]],[/\b(gen\d{3}) b.+49h/i],[a,[u,"Swiss"],[c,f]],[/\b(zur\d{3}) b/i],[a,[u,"Swiss"],[c,h]],[/\b((zeki)?tb.*\b) b/i],[a,[u,"Zeki"],[c,h]],[/\b([yr]\d{2}) b/i,/\b(dragon[- ]+touch |dt)(\w{5}) b/i],[[u,"Dragon Touch"],a,[c,h]],[/\b(ns-?\w{0,9}) b/i],[a,[u,"Insignia"],[c,h]],[/\b((nxa|next)-?\w{0,9}) b/i],[a,[u,"NextBook"],[c,h]],[/\b(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05])) b/i],[[u,"Voice"],a,[c,f]],[/\b(lvtel\-)?(v1[12]) b/i],[[u,"LvTel"],a,[c,f]],[/\b(ph-1) /i],[a,[u,"Essential"],[c,f]],[/\b(v(100md|700na|7011|917g).*\b) b/i],[a,[u,"Envizen"],[c,h]],[/\b(trio[-\w\. ]+) b/i],[a,[u,"MachSpeed"],[c,h]],[/\btu_(1491) b/i],[a,[u,"Rotor"],[c,h]],[/(shield[\w ]+) b/i],[a,[u,"Nvidia"],[c,h]],[/(sprint) (\w+)/i],[u,a,[c,f]],[/(kin\.[onetw]{3})/i],[[a,/\./g," "],[u,Lt],[c,f]],[/droid.+; (cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i],[a,[u,$t],[c,h]],[/droid.+; (ec30|ps20|tc[2-8]\d[kx])\)/i],[a,[u,$t],[c,f]],[/(ouya)/i,/(nintendo) ([wids3utch]+)/i],[u,a,[c,y]],[/droid.+; (shield) bui/i],[a,[u,"Nvidia"],[c,y]],[/(playstation [345portablevi]+)/i],[a,[u,ct],[c,y]],[/\b(xbox(?: one)?(?!; xbox))[\); ]/i],[a,[u,Lt],[c,y]],[/smart-tv.+(samsung)/i],[u,[c,w]],[/hbbtv.+maple;(\d+)/i],[[a,/^/,"SmartTV"],[u,Ut],[c,w]],[/(nux; netcast.+smarttv|lg (netcast\.tv-201\d|android tv))/i],[[u,Bt],[c,w]],[/(apple) ?tv/i],[u,[a,D+" TV"],[c,w]],[/crkey/i],[[a,V+"cast"],[u,st],[c,w]],[/droid.+aft(\w)( bui|\))/i],[a,[u,S],[c,w]],[/\(dtv[\);].+(aquos)/i,/(aquos-tv[\w ]+)\)/i],[a,[u,kn],[c,w]],[/(bravia[\w ]+)( bui|\))/i],[a,[u,ct],[c,w]],[/(mitv-\w{5}) bui/i],[a,[u,Ft],[c,w]],[/\b(roku)[\dx]*[\)\/]((?:dvp-)?[\d\.]*)/i,/hbbtv\/\d+\.\d+\.\d+ +\([\w ]*; *(\w[^;]*);([^;]*)/i],[[u,zt],[a,zt],[c,w]],[/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i],[[c,w]],[/((pebble))app/i],[u,a,[c,C]],[/droid.+; (glass) \d/i],[a,[u,st],[c,C]],[/droid.+; (wt63?0{2,3})\)/i],[a,[u,$t],[c,C]],[/(quest( 2)?)/i],[a,[u,Pn],[c,C]],[/(tesla)(?: qtcarbrowser|\/[-\w\.]+)/i],[u,[c,O]],[/droid .+?; ([^;]+?)(?: bui|\) applew).+? mobile safari/i],[a,[c,f]],[/droid .+?; ([^;]+?)(?: bui|\) applew).+?(?! mobile) safari/i],[a,[c,h]],[/\b((tablet|tab)[;\/]|focus\/\d(?!.+mobile))/i],[[c,h]],[/(phone|mobile(?:[;\/]| [ \w\/\.]*safari)|pda(?=.+windows ce))/i],[[c,f]],[/(android[-\w\. ]{0,9});.+buil/i],[a,[u,"Generic"]]],engine:[[/windows.+ edge\/([\w\.]+)/i],[g,[l,Wi+"HTML"]],[/webkit\/537\.36.+chrome\/(?!27)([\w\.]+)/i],[g,[l,"Blink"]],[/(presto)\/([\w\.]+)/i,/(webkit|trident|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i,/ekioh(flow)\/([\w\.]+)/i,/(khtml|tasman|links)[\/ ]\(?([\w\.]+)/i,/(icab)[\/ ]([23]\.[\d\.]+)/i],[l,g],[/rv\:([\w\.]{1,9})\b.+(gecko)/i],[g,l]],os:[[/microsoft (windows) (vista|xp)/i],[l,g],[/(windows) nt 6\.2; (arm)/i,/(windows (?:phone(?: os)?|mobile))[\/ ]?([\d\.\w ]*)/i,/(windows)[\/ ]?([ntce\d\. ]+\w)(?!.+xbox)/i],[l,[g,Kt,Mn]],[/(win(?=3|9|n)|win 9x )([nt\d\.]+)/i],[[l,"Windows"],[g,Kt,Mn]],[/ip[honead]{2,4}\b(?:.*os ([\w]+) like mac|; opera)/i,/cfnetwork\/.+darwin/i],[[g,/_/g,"."],[l,"iOS"]],[/(mac os x) ?([\w\. ]*)/i,/(macintosh|mac_powerpc\b)(?!.+haiku)/i],[[l,"Mac OS"],[g,/_/g,"."]],[/droid ([\w\.]+)\b.+(android[- ]x86|harmonyos)/i],[g,l],[/(android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i,/(blackberry)\w*\/([\w\.]*)/i,/(tizen|kaios)[\/ ]([\w\.]+)/i,/\((series40);/i],[l,g],[/\(bb(10);/i],[g,[l,N]],[/(?:symbian ?os|symbos|s60(?=;)|series60)[-\/ ]?([\w\.]*)/i],[g,[l,"Symbian"]],[/mozilla\/[\d\.]+ \((?:mobile|tablet|tv|mobile; [\w ]+); rv:.+ gecko\/([\w\.]+)/i],[g,[l,it+" OS"]],[/web0s;.+rt(tv)/i,/\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i],[g,[l,"webOS"]],[/crkey\/([\d\.]+)/i],[g,[l,V+"cast"]],[/(cros) [\w]+ ([\w\.]+\w)/i],[[l,"Chromium OS"],g],[/(nintendo|playstation) ([wids345portablevuch]+)/i,/(xbox); +xbox ([^\);]+)/i,/\b(joli|palm)\b ?(?:os)?\/?([\w\.]*)/i,/(mint)[\/\(\) ]?(\w*)/i,/(mageia|vectorlinux)[; ]/i,/([kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?= linux)|slackware|fedora|mandriva|centos|pclinuxos|red ?hat|zenwalk|linpus|raspbian|plan 9|minix|risc os|contiki|deepin|manjaro|elementary os|sabayon|linspire)(?: gnu\/linux)?(?: enterprise)?(?:[- ]linux)?(?:-gnu)?[-\/ ]?(?!chrom|package)([-\w\.]*)/i,/(hurd|linux) ?([\w\.]*)/i,/(gnu) ?([\w\.]*)/i,/\b([-frentopcghs]{0,5}bsd|dragonfly)[\/ ]?(?!amd|[ix346]{1,2}86)([\w\.]*)/i,/(haiku) (\w+)/i],[l,g],[/(sunos) ?([\w\.\d]*)/i],[[l,"Solaris"],g],[/((?:open)?solaris)[-\/ ]?([\w\.]*)/i,/(aix) ((\d)(?=\.|\)| )[\w\.])*/i,/\b(beos|os\/2|amigaos|morphos|openvms|fuchsia|hp-ux)/i,/(unix) ?([\w\.]*)/i],[l,g]]},J=function(I,M){if(typeof I===m&&(M=I,I=e),!(this instanceof J))return new J(I,M).getResult();var x=I||(typeof t!==s&&t.navigator&&t.navigator.userAgent?t.navigator.userAgent:r),K=M?Hi(Rn,M):Rn;return this.getBrowser=function(){var A={};return A[l]=e,A[g]=e,qe.call(A,x,K.browser),A.major=Gi(A.version),A},this.getCPU=function(){var A={};return A[b]=e,qe.call(A,x,K.cpu),A},this.getDevice=function(){var A={};return A[u]=e,A[a]=e,A[c]=e,qe.call(A,x,K.device),A},this.getEngine=function(){var A={};return A[l]=e,A[g]=e,qe.call(A,x,K.engine),A},this.getOS=function(){var A={};return A[l]=e,A[g]=e,qe.call(A,x,K.os),A},this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS(),device:this.getDevice(),cpu:this.getCPU()}},this.getUA=function(){return x},this.setUA=function(A){return x=typeof A===d&&A.length>_?zt(A,_):A,this},this.setUA(x),this};J.VERSION=n,J.BROWSER=dt([l,g,p]),J.CPU=dt([b]),J.DEVICE=dt([a,u,c,y,f,w,h,C,O]),J.ENGINE=J.OS=dt([l,g]),typeof ot!==s?(typeof Dt!==s&&Dt.exports&&(ot=Dt.exports=J),ot.UAParser=J):i==="object"&&null.amd?null(function(){return J}):typeof t!==s&&(t.UAParser=J);var Ne=typeof t!==s&&(t.jQuery||t.Zepto);if(Ne&&!Ne.ua){var lt=new J;Ne.ua=lt.getResult(),Ne.ua.get=function(){return lt.getUA()},Ne.ua.set=function(I){lt.setUA(I);var M=lt.getResult();for(var x in M)Ne.ua[x]=M[x]}}})(typeof window=="object"?window:ot)});var zi=L(H()),Ki=L(Ln());var gn=L(H());var E=L(H());if(typeof document<"u"){let t=document.createElement("style"),e=window.engagement,n=e&&e._configuration&&e._configuration.nonce;if(n)t.setAttribute("nonce",n);else{let r=document.querySelector("[nonce]");if(r){let o=r.nonce||r.getAttribute("nonce");o&&t.setAttribute("nonce",o)}}t.appendChild(document.createTextNode(`#engagement-wrapper *,
...
`,sa=()=>{let t=G.useSelector(({context:i})=>i.cursor.position.container.placement),e=G.useSelector(ue.isTracingTargetElement),n=G.useSelector(ue.isShowingPin),[r,o]=G.useSelector(({context:i})=>i.cursor.position.arrow.coordinates);return T(si,{style:{transition:n?`transform ${li}ms cubic-bezier(0.78, -0.28, 0.07, 1)`:void 0,transform:t==="right-start"?`translate(${xe(r)}px, ${xe(o)}px)`:`rotate(90deg) translate(${xe(r)}px, ${xe(o)}px)`,offsetRotate:"0deg"},css:e?{offsetPath:`path("${ci(50,30,t==="right-start"?"counter-clockwise":"clockwise")}")`,transformOrigin:t==="right-start"?"0px 0px":"-2px 58px",animation:`${ia} ${wn}ms forwards cubic-bezier(0.45, 0, 0.55, 1)`}:void 0})},aa=je`
  from {
    scale: 1;
    opacity: 100%;
  }
...
`,da=()=>{let t=G.useSelector(ue.isPoppingIn),e=G.useSelector(ue.isSwappingBody),n=G.useSelector(({context:r})=>r.cursor.position.container.placement);return T("div",{style:{position:"relative",gridRowStart:1,gridColumnStart:1,display:"inline-flex",padding:"var(--card-padding, 12px)",alignItems:"center",gap:"var(--card-gap, 8px)",borderRadius:n==="right-start"?"0px var(--card-radius, 8px) var(--card-radius, 8px) var(--card-radius, 8px)":"var(--card-radius, 8px) 0px var(--card-radius, 8px) var(--card-radius, 8px)",border:"1px solid var(--border-primary, #E2E2E2)",background:"var(--background-primary, #FFF)",boxShadow:"0px 4px 16px 0px rgba(0,0,0,0.1)",justifySelf:n==="right-start"?void 0:"flex-end",transformOrigin:"top left"},css:{animation:e?`${aa} 200ms forwards cubic-bezier(.42, 0, .59, 1.33)`:void 0,"&::before":{content:'""',width:"100%",height:"100%",zIndex:-1,background:"var(--base-accent)",position:"absolute",top:0,left:0,opacity:0,borderRadius:n==="right-start"?"0px var(--card-radius, 8px) var(--card-radius, 8px) var(--card-radius, 8px)":"var(--card-radius, 8px) 0px var(--card-radius, 8px) var(--card-radius, 8px)",animation:t?`${ca} 200ms forwards cubic-bezier(0, 0, 0.2, 1)`:void 0}}},T(co,null))},mi=je`
  from {
    scale: 0.8;
    opacity: 40%;
  }
